...
void SET_TIME();
 ...
 void get_time(void);
# 10 "dashboard_func.c" 2
# 1 "./matrix_keypad.h" 1
# 39 "./matrix_keypad.h"
void init_matrix_keypad(void);
unsigned char scan_key(void);
unsigned char read_switches(unsigned char detection_type);
# 11 "dashboard_func.c" 2
# 1 "./eeprom.h" 1
    ...
    get_time();
        ...
        clcd_putch(time[0], (0xC0 + (0)));
         ...
         else if(key==1)
         {
          ...
          clcd_print(event[event_index], (0xC0 + (10)));

         clcd_print("SP", (0x80 + (14)));
         short duty_cycle=(read_adc()/10.33);
          clcd_putch((duty_cycle/10)+48, (0xC0 + (14)));
           clcd_putch((duty_cycle%10)+48, (0xC0 + (15)));
