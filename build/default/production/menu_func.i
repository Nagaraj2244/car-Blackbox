...
void MENU()
{
     ...
     key=read_switches(1);
       ...
       {
           clcd_write(0x01, 0);
        clcd_print(menu_arr[menu_index], (0x80 + (1)));
       clcd_print(menu_arr[menu_index+1], (0xC0 + (1)));
       clcd_putch('*',(0x80 + (0)));
       clcd_putch(' ',(0xC0 + (0)));
        star_flag=1;
       ...
       else
       {
           if(key==3)
           {
             ...
             if(menu_index==4)
             menu_index=3;
         clcd_print(menu_arr[menu_index-1], (0x80 + (1)));
       clcd_print(menu_arr[menu_index], (0xC0 + (1)));
