 ...
 else
 {
  ...
  int x=sl_no*10;
   ...
   else if(key==5)
   {
    ...
    clcd_putch(sl_no+48,(0xC0 + (0)));
    clcd_putch(' ',(0xC0 + (1)));
    clcd_putch(read_internal_eeprom(x),(0xC0 + (2)));
    clcd_putch(read_internal_eeprom(x+1),(0xC0 + (3)));
    clcd_putch(':',(0xC0 + (4)));
    clcd_putch(read_internal_eeprom(x+2),(0xC0 + (5)));
    clcd_putch(read_internal_eeprom(x+3),(0xC0 + (6)));
    clcd_putch(':',(0xC0 + (7)));
    clcd_putch(read_internal_eeprom(x+4),(0xC0 + (8)));
    clcd_putch(read_internal_eeprom(x+5),(0xC0 + (9)));
    clcd_putch(' ',(0xC0 + (10)));
    clcd_putch(read_internal_eeprom(x+6),(0xC0 + (11)));
    clcd_putch(read_internal_eeprom(x+7),(0xC0 + (12)));
    clcd_putch(' ',(0xC0 + (13)));
    clcd_putch(read_internal_eeprom(x+8),(0xC0 + (14)));
    clcd_putch(read_internal_eeprom(x+9),(0xC0 + (15)));
